    ...
    return Drawer(
      child: Column(
        children: [
          ...
          // Phần cuộn cho các mục menu
          Expanded(
            child: ListView(
              padding: EdgeInsets.zero,
              children: [
                _buildMenuOption(
                    screenColorScheme, Icons.add_comment, 'New Chat', () {
                ...
                _buildMenuOption(
                    screenColorScheme, Icons.chat_bubble, 'All chats', () {
                  Navigator.push(
                    context,
                ...
                _buildMenuOption(
                    screenColorScheme, Icons.smart_toy, 'Chat bots', () {
                  Navigator.push(
                    context,
                ...
                _buildMenuOption(
                    screenColorScheme, Icons.book, 'Knowledge base', () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
          ...
          // Phần Authentication cố định phía dưới
