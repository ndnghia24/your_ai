...
class TestChatAIScreen extends StatelessWidget {
        ...
        child: Column(
          ...
          children: [
            ElevatedButton(
              onPressed: () async {
                ...
                if (usecaseResult['isSuccess']) {
                  currentConv = usecaseResult['result'];
                  print(currentConv.toMapString());
                }
            ...
            ElevatedButton(
              onPressed: () async {
                final usecaseResult =
                    await chatAIUseCaseFactory.getConversationsUseCase.execute(
                  assistantId: 'gpt-4o-mini',
                  assistantModel: 'dify',
                );

                if (usecaseResult['isSuccess']) {
                  conversationList = usecaseResult['result'];
                  print(currentConv.toMapString());
                }
            ...
            ElevatedButton(
              ...
              child: const Text('Get Conversations Details'),
            ),
          ],
        ),
      ),
